...
save(strcat('py_simResults_B',num2str(sim_n)),'py_pred','pred_ci','pred_nu','DIC','DIC_star','t_I0','y_mse','nu_mse');
...
thetafile=strcat('theta0sRPC_simB',num2str(sim_n),'.fig');
figure; 
    h=heatmap(t_I0(2:4,:))
...
truethetafile=strcat('theta0simB',num2str(sim_n),'.fig');
figure; 
